...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    shouyeViewController *homevc = [[shouyeViewController alloc] init];
...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    pathStr=[pathStr stringByAppendingPathComponent:@"wsdata.xml"];
    [NSKeyedArchiver archiveRootObject:dictionaryData.mutableArrAll toFile:pathStr];
